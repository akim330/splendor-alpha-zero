...
from ..configs.standard import level_1_cards, level_2_cards, level_3_cards, nobles_list

class StandardSplendor(SplendorVariant):
    """Standard Splendor game with all rules and components."""
    
    def __init__(self):
        """Initialize standard Splendor game."""
        self._load_components()
    
    @property
    def name(self) -> str:
        return "Standard Splendor"
    ...
    def _load_components(self):
        ...
        # Load cards
        self._level_1_cards = level_1_cards
        self._level_2_cards = level_2_cards
        self._level_3_cards = level_3_cards
